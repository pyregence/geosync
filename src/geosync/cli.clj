...
(spec/def ::action-hook-headers (spec/nilable (spec/map-of keyword? any?))) ; headers map is optional
(spec/def ::action-hook         (spec/tuple ::action-run-time ::action url? ::action-hook-params ::action-hook-headers))

...
GeoSync comes with a test suite. You can run it with `clojure -M:test:runner`.

As we improve de codebase, more tests should be written and code-coverage will
increase, making sure we don´t see any regressions.
...
| Layer                                    | Style                       | Match? |
|------------------------------------------+-----------------------------+--------|
| sierra-nevada-fires                      | fires                       | Y      |
| SierraNevada_Tier2_AnnualBurnProbability | annualburnprobability       | Y      |
| SierraNevada_Tier2_AnnualBurnProbability | TIER2_ANNUALBURNPROBABILITY | Y      |
| SierraNevada_Tier2_AnnualBurnProbability | TIER1_ANNUALBURNPROBABILITY | N      |
|------------------------------------------+-----------------------------+--------|

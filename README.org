...
2. Remove All Layers under a Workspace from GeoServer and Delete the Workspace
...
3. Remove All Layers under a Workspace from GeoServer and Delete the Workspace(s)

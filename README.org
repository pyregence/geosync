...
[bug](https://osgeo-org.atlassian.net/browse/GEOS-9166) that will prevent it from
assigning the correctly style if have multiple styles with the same name (even across
